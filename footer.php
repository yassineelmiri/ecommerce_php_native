...
$newsletter_on_off = ''; // Initialize here

if ($result && count($result) > 0) {
    // Extract settings from the first row (assuming id=1 gives one result)
    $row = $result[0];
    ...
    // Check if $newsletter_on_off is set before using it
    if (isset($newsletter_on_off) && $newsletter_on_off == 1) {
?>
...
<?php
    ...
    // Handle case where settings could not be fetched
    echo "Error fetching settings.";
}
?>
